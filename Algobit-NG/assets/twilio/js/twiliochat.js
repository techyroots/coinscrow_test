var twiliochat = (function() {
    ...
    function fetchAccessToken(username, handler) {
        ...
        // $.post('http://localhost:3000/token', { identity: username }, null, 'json')
    ...
    tc.createUniqueChannel = function(uniqueName, friendlyName) {
        tc.messagingClient.createChannel({
...
console.log(typeof twiliochat);
console.log(twiliochat);

function createUniqueChannel(uniqueName, friendlyName) {
    tc.handleNewChannelInputKeypress
}